...
<style>
    ...
    .hero {
        background-image: linear-gradient(rgba(0, 37, 60, 0.46), rgba(0, 60, 94, 0.46)), url('<?php echo $assets_path; ?>/images/hero_background.png');
    ...
    <div class="container">
        ...
        <div class="steps">
            <div class="step">
                ...
                <h4>1. Search & Discover</h4>
                <p>Explore a wide range of internship opportunities filtered by location, industry, and skills.</p>
            </div>
            <div class="step">
                <div class="step-icon">
                ...
                <h4>2. Apply Effortlessly</h4>
                <p>Submit your application with a streamlined form and upload your resume in seconds.</p>
            </div>
            <div class="step">
                <div class="step-icon">
                ...
                <h4>3. Track Your Status</h4>
                <p>Check the real-time status of your application and get notified of updates.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="internship-list">
            <div class="internship-card">
                ...
                <p><strong>Tech Innovators Inc.</strong></p>
                <p>New York, NY</p>
                <a href="<?php echo $pages_path; ?>/learnmore.php" class="learn-more-link">Learn More <i class="fas fa-chevron-right"></i></a>
            ...
            <div class="internship-card">
                ...
                <p><strong>Creative Minds Ltd.</strong></p>
                <p>Los Angeles, CA</p>
                <a href="<?php echo $pages_path; ?>/learnmore.php" class="learn-more-link">Learn More <i class="fas fa-chevron-right"></i></a>
                ...
                <p><strong>DataTech Solutions</strong></p>
