...
$applications_query = "SELECT a.*, i.title as internship_title, i.location, i.salary, 
                    ...
                    <?php foreach ($applications as $app): ?>
                        <div class="application-card">
                            ...
                            <div class="application-details">
                                ...
                                <?php if (!empty($app['salary'])): ?>
                                    <div class="detail-item">
                                        ...
                                        $<?php echo number_format($app['salary'], 2); ?>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="application-actions">
                                <a href="view_internship.php?id=<?php echo $app['internship_id']; ?>" class="btn btn-sm btn-outline">View Details</a>
                                <?php if ($app['status'] === 'draft'): ?>
                                    <a href="apply_vacancy.php?id=<?php echo $app['internship_id']; ?>" class="btn btn-sm btn-primary">Complete Application</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
