...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (empty($errors)) {
            ...
            $stmt = $db->prepare($sql);
            $stmt->execute([
                $title, $company_profile['id'], $category_id, $description, 
                $requirements, $responsibilities, $location, $duration_months, 
                $stipend, $application_deadline, $start_date, $end_date, 
                $max_applicants, $status, $remote_option, $experience_level, $user_id
            ]);
...
<div class="posting-container">
    <div class="posting-header">
        ...
        <p>Create an engaging internship opportunity for students</p>
    </div>
    ...
    <form id="internshipForm" method="POST" class="internship-form">
        ...
        <div class="form-step active" id="step1">
            <div class="step-header">
                ...
                <p>Start with the basics of your internship</p>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group full-width">
                    <label for="title" class="form-label">
                        Internship Title *
                        <small>Make it specific and engaging</small>
                    </label>
                    <input type="text" 
                           class="form-control" 
                           id="title" 
                ...
                <div class="form-group">
                    ...
                    <input type="number" 
                           ...
                           id="stipend" 
                           name="stipend" 
                           value="<?php echo escape($_POST['stipend'] ?? '0'); ?>" 
                           min="0" 
                           step="1000">
                </div>
        ...
        <div class="form-step" id="step2">
            <div class="step-header">
                ...
                <p>Define where and when the internship takes place</p>
            </div>
        ...
        <div class="form-step" id="step4">
            <div class="step-header">
                ...
                <p>Review your internship posting and choose how to publish it</p>
            </div>
            ...
            <div class="publish-options">
                ...
                <div class="radio-group">
                    ...
                    <div class="radio-option">
                        <input type="radio" id="publish_now" name="status" value="published">
